...
class AbstractMultiConnectionNodeTest {
    ...
    static class TestNode<V>
            extends AbstractMultiConnectionNode<V, List<Node<V>>> {
    ...
    void shouldDisconnectConnectedNode() {
        ...
        Node<String> result = node.disconnect(other);
    ...
    void shouldDisconnectOnlySpecifiedNode() {
        ...
        Node<String> result = node.disconnect(first);
    ...
    void shouldAppendAndConnectNewNode() {
        ...
        Node<String> appendedNode = node.append("B");
    ...
    void shouldAppendMultipleNodesSuccessfully() {
        ...
        Node<String> first = node.append("B");
        Node<String> second = node.append("C");
        Node<String> third = node.append("D");
